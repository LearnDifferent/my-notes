[原文地址](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java%E5%AE%9A%E6%97%B6%E4%BB%BB%E5%8A%A1%E5%A4%A7%E6%8F%AD%E7%A7%98?id=%e4%b8%ba%e4%bb%80%e4%b9%88%e9%9c%80%e8%a6%81%e5%ae%9a%e6%97%b6%e4%bb%bb%e5%8a%a1%ef%bc%9f)

## [为什么需要定时任务？](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=为什么需要定时任务？)
...
## [单机定时任务技术选型](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=单机定时任务技术选型)

### [Timer](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=timer)
...
当前时间: Fri May 28 15:18:48 CST 2021n线程名称: TimerCopy to clipboardErrorCopied
```
 ...
 * {@code Timer}.Copy to clipboardErrorCopied
```

大概的意思就是： `ScheduledThreadPoolExecutor` 支持多线程执行定时任务并且功能更强大，是 `Timer` 的替代品。

### [ScheduledExecutorService](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=scheduledexecutorservice)

`ScheduledExecutorService` 是一个接口，有多个实现类，比较常用的是 `ScheduledThreadPoolExecutor` 。

![img](https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/javaguide/20210607154324712.png)
...
当前时间: Fri May 28 15:40:52 CST 2021n线程名称: pool-1-thread-2Copy to clipboardErrorCopied
```

不论是使用 `Timer` 还是 `ScheduledExecutorService` 都无法使用 Cron 表达式指定任务执行的具体时间。

### [Spring Task](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=spring-task)

![img](https://img-blog.csdnimg.cn/20210528145056880.png)
...
### [时间轮](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=时间轮)
...
![img](https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/javaguide/20210607171334861.png)
...
![img](https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/javaguide/20210607193042151.png)
...
![img](https://img-blog.csdnimg.cn/20210607195206797.png)

**时间轮比较适合任务数量比较多的定时任务场景，它的任务写入和执行的时间复杂度都是 0（1）。**

## [分布式定时任务技术选型](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=分布式定时任务技术选型)
...
### [Quartz](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=quartz)

![img](https://img-blog.csdnimg.cn/2021052814502425.png)
...
### [Elastic-Job](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=elastic-job)

![img](https://img-blog.csdnimg.cn/20210528144508114.png)
...
![img](https://img-blog.csdnimg.cn/20210608080437356.png)

ElasticJob-Lite 的架构设计如下图所示：

![img](https://oscimg.oschina.net/oscnet/up-a8f63f828666d43009d5d3497bcbd2cfb61.png)
...
### [XXL-JOB](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=xxl-job)

![img](https://img-blog.csdnimg.cn/20210528144611728.png)

`XXL-JOB` 于 2015 年开源，是一款优秀的轻量级分布式任务调度框架，支持任务可视化管理、弹性扩容缩容、任务失败重试和告警、任务分片等功能，

![img](https://img-blog.csdnimg.cn/20210608080550433.png)

根据 `XXL-JOB` 官网介绍，其解决了很多 `Quartz` 的不足。

![img](https://img-blog.csdnimg.cn/20210607202503193.png)

`XXL-JOB` 的架构设计如下图所示：

![img](https://oscimg.oschina.net/oscnet/up-b8ecc6acf651f112c4dfae98243d72adea3.png)
...
![img](https://img-blog.csdnimg.cn/20210607200728212.png)
...
### [PowerJob](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=powerjob)

![img](https://img-blog.csdnimg.cn/20210528145009701.png)
...
![img](https://oscimg.oschina.net/oscnet/up-795f5e9b0d875063717b1ee6a08f2ff1c01.png)

## [总结](https://snailclimb.gitee.io/javaguide/#/./docs/system-design/Java定时任务大揭秘?id=总结)
